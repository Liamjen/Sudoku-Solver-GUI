...
public class TestGridSupplier 
{
	...
	public static Grid getPuzzle1()		{ return new Grid(PUZZLE_1); }
	...
	public static Grid getPuzzle2()		{ return new Grid(PUZZLE_2); }
	...
	public static Grid getPuzzle3()		{ return new Grid(PUZZLE_3); }
	...
	public static Grid getReject1()		{ return new Grid(REJECT_1); }
	public static Grid getReject2()		{ return new Grid(REJECT_2); }
	public static Grid getReject3()		{ return new Grid(REJECT_3); }
	public static Grid getReject4()		{ return new Grid(REJECT_4); }
	public static Grid getContinue()		{ return new Grid(CONTINUE); }
	public static Grid getAccept()			{ return getSolution1(); }
}
